...
pub(super) async fn run_main_inner(
    ...
    let bootstrap_config = startup_draft
        ...
        .await?;
    let mut cloud_config_bundle = startup_draft
    ...
    let (initial_account_id, reload_cloud_config) = if workload_identity_selected {
        ...
        startup_draft.flush_pending_events().await?;
        match codex_plus_plus::run_startup_account_picker(
        ...
        .map_err(std::io::Error::other)?
        {
            codex_plus_plus::StartupAccountSelection::Continue {
                selected_account_id,
                reload_cloud_config,
            } => (selected_account_id, reload_cloud_config),
            codex_plus_plus::StartupAccountSelection::Exit => {
