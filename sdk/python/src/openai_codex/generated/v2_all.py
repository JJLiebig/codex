...
class PreToolUseGuardianApprovalReviewAction(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    reason: str
    tool_input: Annotated[Any, Field(alias="toolInput")]
    tool_name: Annotated[str, Field(alias="toolName")]
    type: Annotated[
        Literal["preToolUse"], Field(title="PreToolUseGuardianApprovalReviewActionType")
    ]
...
class GuardianApprovalReviewAction(
    RootModel[
        ...
        | PreToolUseGuardianApprovalReviewAction
